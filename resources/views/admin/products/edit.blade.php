<x-layouts.admin-layout>
    <form class="" method="POST" action="{{ route('admin.products.update', $product->slug) }}"
            ...
            <div class="pb-12 border-b border-gray-900/10">
                ...
                <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="col-span-full">
                        <label for="sellers" class="block font-medium text-gray-900 dark:text-gray-300 text-sm/6">Select
                            User</label>
                        <select id="sellers" name="seller"
                            class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pl-3 pr-8 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            @foreach ($sellers as $seller)
                                <option {{ $product->user_id === $seller->id ? 'selected' : '' }}
                    ...
                    <div class="col-span-full">
                        <label for="is_featured" class="block font-medium text-gray-900 dark:text-gray-300 text-sm/6">is
                            featured</label>
                    ...
                    <div class="col-span-full">
                        <label for="stock"
                            class="block font-medium text-gray-900 dark:text-gray-300 text-sm/6">stock</label>
                        <div
                            class="flex items-center pl-3 bg-white rounded-md outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
            ...
            <div class="pb-12 border-b border-gray-900/10">
                ...
                <div class="grid grid-cols-1 mt-10 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <label for="price"
                            class="block font-medium text-gray-900 dark:text-gray-300 text-sm/6">Price</label>
                        <div class="mt-2">
