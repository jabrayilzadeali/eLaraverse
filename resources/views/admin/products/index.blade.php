        ...
        <table class="w-full overflow-x-scroll table-auto dark:border-neutral-700">
            <thead>
                <tr class="pt-3 text-sm border-b dark:border-neutral-700 text-neutral-300">
                    ...
                    <x-table.th>Created_by</x-table.th>
                    <x-table.th>Slug</x-table.th>
                    <x-table.th hasSorting={{ true }} :sorts="$sorts" sortQuery='title'>Title</x-table.th>
                    <x-table.th>Description</x-table.th>
                    <x-table.th>Img</x-table.th>
                    <x-table.th hasSorting={{ true }} :sorts="$sorts" sortQuery='rating'>Rating</x-table.th>
                    <x-table.th>Is_featured</x-table.th>
                    <x-table.th>Stock</x-table.th>
                    <x-table.th hasSorting={{ true }} :sorts="$sorts" sortQuery='price'>Price</x-table.th>
                    <x-table.th>Date</x-table.th>
                    <x-table.th>Operations</x-table.th>
                </tr>
            </thead>
            <tbody>
