    ...
    <div class="flex flex-col justify-center min-h-full px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img class="w-auto h-10 mx-auto" src="{{ asset('img/logo.png') }}"
                alt="Your Company">
            <h2 class="mt-10 font-bold tracking-tight text-center text-gray-900 dark:text-gray-100 text-2xl/9">Register</h2>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="/register" method="POST">
                ...
                <div>
                    <label for="username" class="block font-medium text-gray-900 dark:text-gray-300 text-sm/6">Username</label>
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <label for="password_confirmation" class="block font-medium text-gray-900 dark:text-gray-300 text-sm/6">Re Enter Password</label>
                    </div>
                    <div class="mt-2">
            ...
            <p class="mt-10 text-center text-gray-500 dark:text-gray-400 text-sm/6">
                Already a member
                <a href="/login" class="font-semibold text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-600">Login</a>
            </p>
        </div>
    </div>
</x-layouts.auth-layout>
