...
<x-layout>
    @auth
        <div class="flex justify-center gap-3 mb-5">
            ...
            @endcan
            @can('update', $product)
                <a class="px-3 py-2 font-semibold text-white bg-indigo-500 rounded-md"
        ...
        <div
            ...
            <div class="flex items-center col-span-2 grid-rows-3 gap-3">
                <p class="p-1 text-sm font-semibold text-black bg-white rounded-md md:text-base w-fit">ELaraverse's
                    <span class="text-orange-800">Choice</span></p>
    ...
    <div class="mt-8">
        ...
        <form class="my-5" action="">
            ...
            <input type="number" name="number" id="rating"
                class="p-2 rounded-md dark:bg-gray-800 dark:text-gray-300 ring-1 ring-gray-500">
            <label class="block my-3" for="comment">Comment</label>
            <textarea name="comment" id="comment" cols="30" rows="10"
                class="p-3 dark:text-gray-300 ring-1 ring-gray-500 dark:bg-gray-800"></textarea>
